...
<body class="container-fluid">
    ...
    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#details">Course Details</button>
    <a data-bs-toggle="modal" href="#details">Course Details</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                            <img src="../../public/images/a1.jpg" width="150" height="150">
                        </div>
                        <div class="col">
                            <h2>ASP.NET</h2>
                            <ul>
